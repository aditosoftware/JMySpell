...
public class DictionaryConfigPanel extends javax.swing.JPanel {
  ...
  public class UninstallAction extends AbstractAction implements ItemListener {
    ...
    public void itemStateChanged(ItemEvent e) {
      if (ItemEvent.SELECTED == e.getStateChange()) {
        ...
        if (selObj instanceof LocaleProvider) {
  ...
  protected void fillDictionaries() {
    ...
    loader.submit(new Runnable() {
      ...
      public void run() {
        ...
        List<LocaleProvider> locales = dm.getInstalledLocales();
        Collections.sort(locales, new Comparator<LocaleProvider>() {

          public int compare(LocaleProvider o1, LocaleProvider o2) {
  ...
  protected void fillCombobox(final List<LocaleProvider> locales) {
    Runnable run = new Runnable() {
      ...
      public void run() {
        ...
        if (locales.isEmpty()) {
          ...
          for (LocaleProvider localeProvider : locales) {
  ...
  private void initComponents() {
    ...
    basicPropertiesPanelLayout.linkSize(javax.swing.SwingConstants.HORIZONTAL, new Component[] {resetIgnoreWordsButton, resetReplaceWordsButton});
