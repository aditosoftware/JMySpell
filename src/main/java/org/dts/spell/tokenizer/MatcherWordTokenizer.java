...
public class MatcherWordTokenizer extends AbstractWordTokenizer
{
   ...
   * <code>{@link CharSequence CharSequence}</code>) dada.
   * 
   * @param regexp
   ...
   *          <code>{@link java.util.regex.Pattern#compile(String, int) Pattern.compile}</code>.
   * 
   ...
   * Esta función crea un <code>{@link java.util.regex.Matcher Matcher}</code>
   * para buscar las palabras dentro de la (
   * <code>{@link CharSequence CharSequence}</code>) dada. Haciendo
   ...
   *         obtener las palabras.
   * 
   * @see org.dts.spell.tokenizer.MatcherWordTokenizer#SPACE_CHARS SPACE_CHARS
   */
